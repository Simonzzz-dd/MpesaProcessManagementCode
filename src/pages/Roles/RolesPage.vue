<template>
  <div class="row q-pa-md bg-accent appearBox2" style="min-height: 100vh">
    ...
    <div class="col-4 q-pl-md">
      ...
      <q-card v-if="selectedUser" flat class="bg-white text-dark q-mt-md q-pt-md">
        <div class="image-avatar-1 bg-secondary" style="border-radius: 100%; ">
          <img :src="selectedUser.status === 'Active' ? '/unlocked.png' : '/lock.png'"
      ...
      <q-card v-if="selectedUser" flat class="bg-white text-dark q-mt-md q-pt-md">
        <div class="image-avatar-1 bg-primary" style="border-radius: 100%;">
          <img src="/group.png" style="position: absolute; object-position: fit; height: 60%; width: 60%">
        </div>
        ...
        <q-card-actions align="center">
          <q-btn color="primary" label="Add Group" @click="openAddGroupDialog" />
        </q-card-actions>
      </q-card>
    </div>
  </div>
  ...
  <q-dialog v-model="addGroupDialog" persistent>
    <q-card style="min-width: 350px">
      ...
      <q-card-actions align="right" class="text-primary">
        ...
        <q-btn flat label="Add" @click="addGroupsToUser" v-close-popup />
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
