      ...
      <template v-slot:after>
        ...
        >
          <q-tab-panel :name="group.name" v-for="group in flattenedGroups" :key="group.name">
            <div class="text-h6 q-mb-md">{{ group.name }}</div>
            ...
            <div class="q-mb-md">
              ...
              <q-chip v-for="permission in group.userPermissions" :key="permission" color="dark" text-color="white" size="sm" class="q-ma-xs">
                {{ permission }}
              </q-chip>
            </div>
            ...
            <q-list bordered separator>
              <q-item v-for="user in group.users" :key="user._id">
                ...
                <q-item-section side>
                  <q-chip v-for="permission in user.userPermissions" :key="permission" color="secondary" text-color="white" size="sm">
                    {{ permission }}
                  </q-chip>
                </q-item-section>
              </q-item>
            ...
            <q-list bordered separator>
              <q-item v-for="folder in group.folders" :key="folder._id">
                ...
                <q-item-section side>
                  <q-chip v-for="permission in folder.permissions" :key="permission" color="secondary" text-color="white" size="sm">
                    {{ permission }}
                  </q-chip>
                </q-item-section>
              </q-item>
    ...
    <q-dialog v-model="createGroupDialog" persistent>
      <q-card style="min-width: 350px">
        ...
        <q-card-actions align="right" class="text-primary">
          ...
          <q-btn flat label="Create" @click="createGroup" v-close-popup />
        </q-card-actions>
      </q-card>
    </q-dialog>
      ...
      <q-card style="min-width: 350px">
        ...
        <q-card-section class="q-pt-none">
          <q-select
            ...
            :options="unassociatedDirectories"
            option-label="name"
            option-value="_id"
        ...
        <q-card-actions align="right" class="text-primary">
          <q-btn flat label="Cancel" v-close-popup />
          <q-btn flat label="Add" @click="addGroupToDirectoryHandler" v-close-popup />
        </q-card-actions>
      </q-card>
    </q-dialog>
  </div>
...
import { getDirectoriesByGroup, getUnassociatedRootDirectories,  } from 'boot/directories'
