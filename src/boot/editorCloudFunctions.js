...
export default boot(({ app }) => {
  ...
  app.config.globalProperties.$editorCloudF = { uploadFiles, uploadImages, editFile, createNewFileVersion }
})

export { uploadFiles, uploadImages, editFile, createNewFileVersion }
